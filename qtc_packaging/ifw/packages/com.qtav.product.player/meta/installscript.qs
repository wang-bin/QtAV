...
Component.prototype.createOperations = function()
{
    ...
    if (installer.value("os") === "win") {
        ...
        component.addOperation("GlobalConfig", "HKEY_CURRENT_USER\\SOFTWARE\\Classes\\*\\shell\\Open With QtAV QML\\command", "Default", "\"@TargetDir@/bin/QMLPlayer.exe\" -vd \"DXVA;FFmpeg\" -f \"%1\"");
    }
